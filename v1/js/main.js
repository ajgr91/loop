$(function() {
	...
	$('.register-login-wrapper a.login').click(function() {
		$('.login-wrapper').css({bottom: "-780px",opacity:"1"});
		$('.register-wrapper').css({bottom: "-1200px"});
	});

	$('.login-wrapper a.close-icon').click(function() {
		$('.login-wrapper').css({bottom: "-1200px"});
	});

	$('.register-login-wrapper button.register').click(function() {
		$('.register-wrapper').css({bottom: "-675px",opacity:"1"});
		$('.login-wrapper').css({bottom: "-1200px"});
	});
	$('.register-wrapper a.close-icon').click(function() {
		...
		$('#registerFormStep1').css({opacity:"1"});
		$('.register-page').removeClass('active');
		$('.register-pagination').css({top: "285px"});
	...
	$('#registerFormStep1 button').click(function() {
		$( ".register-wrapper" ).animate({
		    bottom: "-1200px",
		  	...
		  	$('#registerFormStep1').removeClass('active');
		  	$('.register-pagination').css({top: "340px"});
		  	$('.register-page').removeClass('active');
		  	$('.register-page:last-child').addClass('active');
			$( ".register-wrapper" ).delay( 250 ).animate({
			    bottom: "-620px",
			}, 0, function() {
			  	$('#registerFormStep2').addClass('active');
		  	});
	    });
 });
