...
<div class="content">
    <section class="primary-blocks align-content">
        <div class="titles">
    ...
    <section class="login-wrapper">
        <form id="loginForm" action="" method="post" class="align-content">
            <a class="close-icon">
    ...
    <section class="register-wrapper">
        <form id="registerFormStep1" action="" method="post" class="active  align-content">
            <a class="close-icon">
                <span class="line"></span>
                <span class="line"></span>
            </a>
        ...
        <form id="registerFormStep2" action="" method="post" class=" align-content">
            <a class="close-icon">
                <span class="line"></span>
                <span class="line"></span>
            </a>
